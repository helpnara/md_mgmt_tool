# 과제 이력 관리 도구 — 설계 문서 (v0.5)

작성일: 2026-09-01 · 상태: **M0~M4 구현 완료**
변경 이력
...
| **M5. 내보내기 & 백업** ◀ 다음 | 단일 md 병합(zip/inline/link), 보고 이력 포함, HTML, 전체 zip 백업 | 보고 직전 과제 이력을 md 한 개로 받아 그대로 붙여넣을 수 있다 |
